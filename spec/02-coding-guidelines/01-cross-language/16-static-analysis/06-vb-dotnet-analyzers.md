...
| 3 | Boolean naming (is, has as prefix is only acceptable and nothing else acceptable including but not limited to can, should etc/Was/Will`) | .NET Analyzers | CA1716, CA1720 | Warning | Partial; custom Roslyn analyzer recommended |
