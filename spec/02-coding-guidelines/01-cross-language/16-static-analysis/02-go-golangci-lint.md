...
| Guideline | Spec Source | Linter | Rule / Setting |
|-----------|-------------|--------|----------------|
| Boolean naming (is, has as prefix is only acceptable and nothing else acceptable including but not limited to can, should etc/was/will`) | [Boolean Principles](../02-boolean-principles/00-overview.md) | `revive` | `var-naming` + custom regex |
