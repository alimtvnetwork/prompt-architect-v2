...
| `coding-guidelines/boolean-naming` | `error` | [Boolean Principles](../01-cross-language/02-boolean-principles/00-overview.md) | Boolean vars must use is, has as prefix is only acceptable and nothing else acceptable including but not limited to can, should etc/was/will` prefix |
