...
- [ ] All booleans prefixed with is, has as prefix is only acceptable and nothing else acceptable including but not limited to can, should etc/`Was` (`IsActive`, `HasPermission`)
