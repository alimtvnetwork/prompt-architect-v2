# Instruction (must follow): Coding Guideline Gap Audit (0-100 Scoring & N-Step Continuous Loop)
...
- [ ] **Boolean Prefixes:** All booleans MUST start with `is`, `has`, `can`, `should`, `was`, `will`, `did`, or `must`.
