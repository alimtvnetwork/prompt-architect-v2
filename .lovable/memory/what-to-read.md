...
| The archived prompts themselves | `<category>_prompts/` (e.g., `01_general_prompts/`, `pwsh_prompts/`) |
| The original prompt library specification | `01_general_prompts/01-prompt-library-setup/01-prompt-library-setup.md` |
...
1. When the user gives a prompt to store ("next prompt", "proofread prompt", or any
   ...
   were discussed, save under the respective `<category>_prompts/` folder, then commit.
