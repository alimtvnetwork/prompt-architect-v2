...
| The archived prompts themselves | `01-prompts/` |
| The original prompt library specification | `01-prompts/01-general/01-prompt-library-setup/01-prompt-library-setup.md` |
...
1. When the user gives a prompt to store ("next prompt", "proofread prompt", or any
   ...
   were discussed, save under `01-prompts/`, then commit.
